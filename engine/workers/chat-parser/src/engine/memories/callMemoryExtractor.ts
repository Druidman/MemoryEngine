...
export const ExtractedMemoryWithDateSchema = ExtractedMemorySchema.extend({
  created_at: z.iso.time()
})
export type ExtractedMemoryType = z.infer<typeof ExtractedMemorySchema>
export type ExtractedMemoryWithDateType = z.infer<typeof ExtractedMemoryWithDateSchema>
